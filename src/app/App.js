        ...
        <nav className="light-red darken-4">
          <div className="container">
            <div className="nav-wrapper">
              <a href="#" className="brand-logo">Prueba xd mern</a>
            </div>
          </div>
        </nav>
              ...
              <div className="card">
                <div className="card-content">
                  <form onSubmit={this.addTask}>
                    ...
                    <button type="submit" className="btn light-red darken-4">
                      Send 
                    </button>
                  </form>
                </div>
                    ...
                    this.state.tasks.map(task => {
                      return (
                        <tr key={task._id}>
                          ...
                          <td>
                            <button onClick={() => this.deleteTask(task._id)} className="btn light-red darken-4">
                              <i className="material-icons">delete</i> 
                            </button>
                            <button onClick={() => this.editTask(task._id)} className="btn light-red darken-4" style={{margin: '4px'}}>
